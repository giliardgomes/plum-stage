import { Stack, Flex, Text, Avatar } from "@mantine/core"
import { useNavigate } from "react-router-dom"
import classes from "./AIBillTracker.module.css"
import { Sidebar } from "../../lib/molecules/Sidebar"
import React from "react"
import { MagnifyingGlassFarFAIcon, PlusFarFAIcon } from "../../lib/components/Icons"
import { Button } from "../../lib/components/Button"

export function AIBillTracker() {
                ...
                >
                    ...
                    <Stack className={classes.main} h={"100%"} w={"100%"} gap={0}>
                        <Stack className={classes.pageContent}>
                            <Stack className={classes.emptyState}>
                                <Text c="gray.7" fw={500} size="lg" lh={"1.75rem"} lts={"0.01875rem"}>Nothing to show yet</Text>
                                <Text size="md" lh={"1.5rem"} c={"gray.7"} lts={"0.01875rem"}>Set up an AI Tracker to start reviewing recommended bills based on your priorities.</Text>
                                <Button
                                    variant="primary"
                                    size="sm"
